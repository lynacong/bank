...
// Colors
//var TASK_COLOR = Color.get(242, 246, 255); // original: Color.get(255, 255, 204);
var TASK_COLOR = "#CDC9C9"; // original: Color.get(255, 255, 204);
//var TASK_STROKE_COLOR = Color.get(58, 58, 58); /*Color.SlateGrey; */
var TASK_STROKE_COLOR = "#CDC9C9"; /*Color.SlateGrey; */
//var EXPANDED_SUBPROCESS_ATTRS = Color.black; /*Color.SlateGrey; */
var BOUNDARY_EVENT_COLOR = Color.get(255,152,7);
var CONDITIONAL_INDICATOR_COLOR = Color.get(255, 255, 255);
//var HIGHLIGHT_COLOR = Color.get(255,225,225);20170713
var HIGHLIGHT_COLOR = "#FF3333";
var HIGHLIGHT_STROKE_COLOR = Color.get(165,5,0);
//var CURRENT_COLOR = Color.get(240,252,225);20170713
var CURRENT_COLOR = "#00CC33";

var CURRENT_STROKE_COLOR = Color.get(95,180,15);
...
var START_EVENT_COLOR = Color.Green;
var START_EVENT_STROKE_COLOR = Color.black; /* Color.SlateGrey; */
var END_EVENT_COLOR = Color.Red;
//var END_EVENT_STROKE_COLOR = Color.black;
var NONE_END_EVENT_COLOR = Color.Red;
var NONE_END_EVENT_STROKE_COLOR = Color.Black;
var ERROR_END_EVENT_COLOR = Color.Red;
var ERROR_END_EVENT_STROKE_COLOR = Color.Black;
...
var LABEL_FONT = {font: "12px Arial", "font-style":"italic", opacity: 1, "fill": LABEL_COLOR};
var LABEL_FONT_SMOOTH = {font: "10px Arial", "font-style":"italic", opacity: 1, "fill": LABEL_COLOR, stroke: LABEL_COLOR, "stroke-width":.4};
var TASK_FONT = {font: "12px Arial", opacity: 1, fill: Color.black};
var TASK_FONT_SMOOTH = {font: "11px Arial", opacity: 1, fill: Color.black, stroke: LABEL_COLOR, "stroke-width":.4};
var POOL_LANE_FONT = {font: "12px Arial", opacity: 1, fill: Color.black};
var EXPANDED_SUBPROCESS_FONT = {font: "12px Arial", opacity: 1, fill: Color.black};

// Strokes
var NORMAL_STROKE = 1.3;
var SEQUENCEFLOW_STROKE = 1.5;
var SEQUENCEFLOW_HIGHLIGHT_STROKE = 2;
var THICK_TASK_BORDER_STROKE = 0.5;
var GATEWAY_TYPE_STROKE = 3.2;
var END_EVENT_STROKE = NORMAL_STROKE+2;
var MULTI_INSTANCE_STROKE = 1.3;
var EVENT_SUBPROCESS_ATTRS = 	{"stroke": "#bbbbbb", "stroke-width": NORMAL_STROKE, "stroke-dasharray": ". ","fill": "#E6F5FC"};
//var EXPANDED_SUBPROCESS_ATTRS = {"stroke": Color.black, "stroke-width": NORMAL_STROKE, "fill": Color.FloralWhite};
var EXPANDED_SUBPROCESS_ATTRS = {"stroke": "#f4cd7f", "stroke-width": NORMAL_STROKE, "fill": "#FEF7E4"};
var NON_INTERRUPTING_EVENT_STROKE = "- ";

var TASK_CORNER_ROUND = 5;
var EXPANDED_SUBPROCESS_CORNER_ROUND = 5;
...
var USERTASK_IMAGE = 		"diagram-viewer/images/deployer/user.png";
var APPROVEUSERTASK_IMAGE = 		"diagram-viewer/images/deployer/approveuser.png";
var SCRIPTTASK_IMAGE = 		"diagram-viewer/images/deployer/script.png";
var SERVICETASK_IMAGE = 	"diagram-viewer/images/deployer/service.png";
var RECEIVETASK_IMAGE = 	"diagram-viewer/images/deployer/receive.png";
var SENDTASK_IMAGE = 		"diagram-viewer/images/deployer/send.png";
...
var SIGNAL_THROW_IMAGE = 	"diagram-viewer/images/deployer/signal_throw.png";
var MULTIPLE_CATCH_IMAGE = 	"diagram-viewer/images/deployer/multiple_catch.png";
var MESSAGE_COMPENSATE_IMAGE = 	"diagram-viewer/images/deployer/forcompensation.png";
var MESSAGE_COMPENSATE_THROW_IMAGE="diagram-viewer/images/deployer/forcompensation.png";
var EXCLUSIVE_GATEWAY_IMAGE= "diagram-viewer/images/deployer/gateway/exclusive.png";
var COMPLEX_GATEWAY_IMAGE= "diagram-viewer/images/deployer/gateway/complex.png";
var EVENT_GATEWAY_IMAGE= "diagram-viewer/images/deployer/gateway/event.png";
var INCLUSIVE_GATEWAY_IMAGE= "diagram-viewer/images/deployer/gateway/inclusive.png";
var PARALLEL_GATEWAY_IMAGE= "diagram-viewer/images/deployer/gateway/parallel.png";
...
// TODO: generate polylineId or do something!!
	...
	*/
	...
	//20170703
	/*drawApproveUserTask: function(name, x, y, width, height) {
		  this.g.setStart();
			this._drawTask(name, x, y, width, height);
			var img = this.g.image(USERTASK_IMAGE, x + ICON_PADDING, y + ICON_PADDING, ICON_SIZE, ICON_SIZE);
			var set = this.g.setFinish();
		...
		drawApproveUserTask: function(name, x, y, width, height) {
			  this.g.setStart();
				this._drawTask(name, x, y, width, height);
				var img = this.g.image(APPROVEUSERTASK_IMAGE, x + ICON_PADDING, y + ICON_PADDING, ICON_SIZE, ICON_SIZE);
				var set = this.g.setFinish();
				this.addHandlers(set, x, y, width, height, "task");
			},
	...
	*/
	...
	highLightActivity: function(activityId){
		...
		/*shape.attr("stroke-width", THICK_TASK_BORDER_STROKE);
		shape.attr("stroke", HIGHLIGHT_COLOR);  20170705*/
		
		shape.attr("stroke-width", THICK_TASK_BORDER_STROKE);
		shape.attr("fill", HIGHLIGHT_COLOR);
		shape.attr("stroke", HIGHLIGHT_STROKE_COLOR);
		
	},
	
	//begin_新增当前执行节点的高亮显示_20170705
		highLightCurrentActivity: function(activityId){
			var shape = this.g.getById(activityId);
			if (!shape) {
				console.error("Activity " + activityId + " not found");
				return;
			...
			shape.attr("stroke-width", THICK_TASK_BORDER_STROKE);
			shape.attr("fill", CURRENT_COLOR);
			shape.attr("stroke", CURRENT_STROKE_COLOR);
			
		},
	//end_新增当前执行节点的高亮显示_20170705
