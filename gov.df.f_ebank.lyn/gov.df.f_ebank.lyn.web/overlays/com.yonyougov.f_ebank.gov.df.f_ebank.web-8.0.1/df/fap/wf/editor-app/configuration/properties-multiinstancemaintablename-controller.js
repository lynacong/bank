var KisBpmMultiInstancemaintablenameCtrl = [ '$scope','$http','$rootScope', function($scope,$http,$rootScope) {
	 ...
	 $scope.multiInstanceModelChanged = function() {
	       ...
	       for (var p=0;p<$scope.items.length;p++)
		 {
		   if($scope.property.value=="luru"){
		     ...
		     $rootScope.mainTableCN=$scope.items[p].id_column_name;
		     //$rootScope.outterTableCN=null;
