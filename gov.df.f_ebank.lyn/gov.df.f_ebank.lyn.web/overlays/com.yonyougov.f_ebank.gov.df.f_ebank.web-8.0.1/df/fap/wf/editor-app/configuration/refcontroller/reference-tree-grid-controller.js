...
var KisBpmReferenceTreeGridCtrl = [ '$scope', '$modal', '$timeout', '$translate', '$location', function($scope, $modal, $timeout, $translate, $location) {

    // Config for the modal window
    var opts = {
        template:  'editor-app/configuration/properties/reference/treegrid/reference-popup.html?version=' + Date.now(),
        scope: $scope
    };
...
var KisBpmReferenceTreeGridPopupCtrl = ['$scope', '$q', '$translate', '$http', '$timeout', '$cookieStore', '$element', function($scope, $q, $translate, $http, $timeout, $cookieStore, $element) {
