...
var KisBpmDeptReferenceTreeGridCtrl = [ '$scope', '$modal', '$timeout', '$translate', function($scope, $modal, $timeout, $translate) {

    // Config for the modal window
    var opts = {
        template:  'editor-app/configuration/properties/reference/depttreegrid/reference-popup.html?version=' + Date.now(),
        scope: $scope
    };
...
var KisBpmDeptReferenceTreeGridPopupCtrl = ['$scope', '$q', '$translate', '$http', '$timeout', '$cookieStore', '$element', function($scope, $q, $translate, $http, $timeout, $cookieStore, $element) {
	...
	$scope.refRuleData=[{"pk":"currentStaffTopDept","code":"currentStaffTopDept","name":"当前人员顶级部门"},{"pk":"currentUserParentDept","code":"currentUserParentDept","name":"当前人父部门"},
	                    {"pk":"currentUserTopDept","code":"currentUserTopDept","name":"当前人顶级部门"},{"pk":"currentProcessDept","code":"currentProcessDept","name":"当前流程部门"}];
...
/*
	...
	function onAsyncSuccess(event, treeId, treeNode, msg) {
		...
		if(treeNode){
			...
			if(zTree.getNodes().length < totalCount){
				setTimeout(function() {ajaxGetNodes(treeNode);}, perTime);
			}else{
				zTree.updateNode(treeNode);
			}
