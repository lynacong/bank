...
var KisBpmEventListenersPopupCtrl = [ '$scope', '$q', '$translate','$timeout', function($scope, $q, $translate,$timeout) {
    ...
    $scope.listenerTypeChanged = function(type) {
    ...
    $scope.addNewListener = function() {
        $scope.eventListeners.push({ event : '',
            ...
            retrowEvent: false});
        $timeout(function(){
                    $scope.gridOptions.selectItem($scope.eventListeners.length - 1, true);   
                }, 100);
    };
