...
var KisBpmFieldsPopupCtrl = [ '$scope', '$translate', '$timeout',function($scope, $translate,$timeout) {
    ...
    $scope.gridOptions = {
        ...
        columnDefs: [{ field: 'name', displayName: ORYX.I18N.Fields.Name },
                     { field: 'implementation', displayName: ORYX.I18N.Fields.Implementation},
                     { field: 'expression', displayName: ORYX.I18N.Fields.Expression}]
    };
