        ...
        if ($scope.selectedProperties.length > 0) {
            ...
            if (index != 0) { // If it's the first, no moving up of course
                ...
                $timeout(function(){
                    ...
                    $scope.gridOptions.$gridScope.selectionProvider.lastClickedRow = $scope.gridOptions.$gridScope.gridOptions.ngGrid.rowCache[index - 1];
                    $scope.gridOptions.$gridScope.selectionProvider.lastClickedRowIndex = index - 1;
                }, 10);
