...
var KisBpmOutParametersPopupCtrl = [ '$scope', '$q', '$translate','$timeout', function($scope, $q, $translate,$timeout) {
    ...
    $scope.addNewParameter = function() {
        $scope.parameters.push({ source : '',
            ...
            targetExpression : ''});
        $timeout(function(){
        	$scope.gridOptions.selectItem($scope.parameters.length - 1, true);
        }, 100);
    };
