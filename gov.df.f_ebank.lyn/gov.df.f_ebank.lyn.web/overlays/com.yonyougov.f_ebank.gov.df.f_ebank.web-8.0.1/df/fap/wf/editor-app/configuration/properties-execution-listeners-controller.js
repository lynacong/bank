...
var KisBpmExecutionListenersPopupCtrl = [ '$scope', '$q', '$translate', '$timeout',function($scope, $q, $translate,$timeout) {
    ...
    if ($scope.property.value !== undefined && $scope.property.value !== null
        ...
        for (var i = 0; i < $scope.executionListeners.length; i++)
        {
            ...
            switch($scope.executionListeners[i].event){
    		case "start":
    			$scope.executionListeners[i].event_displayname = ORYX.I18N.Listeners.Start;
    			break;
    		case "end":
    			$scope.executionListeners[i].event_displayname = ORYX.I18N.Listeners.End;
    			break;
    		case "take":
    			$scope.executionListeners[i].event_displayname = ORYX.I18N.Listeners.Take;
    			break;
    		default:
    			break;
    ...
    $scope.eventChanged = function(){
    	switch($scope.selectedListeners[0].event){
    		case "start":
    			$scope.selectedListeners[0].event_displayname = ORYX.I18N.Listeners.Start;
    			break;
    		case "end":
    			$scope.selectedListeners[0].event_displayname = ORYX.I18N.Listeners.End;
    			break;
    		case "take":
    			$scope.selectedListeners[0].event_displayname = ORYX.I18N.Listeners.Take;
    			break;
    		default:
    			break;
    	}
    ...
    $scope.addNewListener = function() {
        $scope.executionListeners.push({ event : 'start',
        	event_displayname : ORYX.I18N.Listeners.Start,
            implementation : '',
            className : '',
            expression: '',
            delegateExpression: '',
            clazz: 'class'});
        $timeout(function(){
                    $scope.gridOptions.selectItem($scope.executionListeners.length - 1, true);   
                }, 100);
    };
