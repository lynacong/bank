...
var KisBpmSequenceExecutionListenersCtrl = [ '$scope', '$modal', '$timeout', '$translate', function($scope, $modal, $timeout, $translate) {

    // Config for the modal window
    var opts = {
        template:  'editor-app/configuration/properties/sequenceexecution-listeners-popup.html?version=' + Date.now(),
        scope: $scope
    };
...
var KisBpmSequenceExecutionListenersPopupCtrl = [ '$scope', '$q', '$translate', '$timeout',function($scope, $q, $translate,$timeout) {
    ...
    $scope.addNewListener = function() {
        $scope.executionListeners.push({ event : 'take',
        	event_displayname : ORYX.I18N.Listeners.Take,
            implementation : '',
            className : '',
            expression: '',
            delegateExpression: ''});
