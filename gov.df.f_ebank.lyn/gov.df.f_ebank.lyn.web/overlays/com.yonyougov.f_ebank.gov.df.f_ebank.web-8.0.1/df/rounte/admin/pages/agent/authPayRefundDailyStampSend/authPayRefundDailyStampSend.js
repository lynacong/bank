define(['text!pages/agent/authPayRefundDailyStampSend/authPayRefundDailyStampSend.html',
	...
	'bootstrap','ip','ebankConstants','datatables.net-bs', 
     ...
     'initDataTableUtil'  ],
		...
		mainOptions["queryTable"] = EBankConstant.PayTables.EBANK_DAY_BILL;
		mainOptions["detailTable"] = EBankConstant.PayTables.EBANK_PAY_DETAIL;
		mainOptions["isWorkFlowRelated"] = "true";
		mainOptions["relationBillId"] = "day_bill_id";
		//查询明细参数
