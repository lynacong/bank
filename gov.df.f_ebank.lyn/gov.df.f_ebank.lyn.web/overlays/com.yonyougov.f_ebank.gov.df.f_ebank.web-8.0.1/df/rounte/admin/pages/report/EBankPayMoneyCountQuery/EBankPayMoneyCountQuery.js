define(['text!pages/report/EBankPayMoneyCountQuery/EBankPayMoneyCountQuery.html',
	...
	var init =function(element,param){ 	
		document.title=ip.getUrlParameter("menuname"); 
			...
			printBillfunction=function(evt){
				...
				previewFile(dataList,ip.getUrlParameter("reportmould"),"0",ip.getTokenId(),ip.getUrlParameter("pagesize"));
