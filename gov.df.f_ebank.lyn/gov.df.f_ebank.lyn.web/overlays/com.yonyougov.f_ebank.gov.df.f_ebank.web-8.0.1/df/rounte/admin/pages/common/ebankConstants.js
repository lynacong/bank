...
//签章发送
EBankConstant.SignSendUrl = {
		PBToCZ:"/df/f_ebank/billStampSend/doSignSend.do",//代理银行到财政签章发送
		PBToCZ_A:"/df/f_ebank/billStampSend/doAgainSend.do",//代理银行到财政重新发送
		PBToCZAsCB:"/df/f_ebank/billStampSend/doSignAndSendToCzWithDes.do",//代理银行预算外清算 签章发送 带des的签章发送到财政
		PBToCB:"/df/f_ebank/billStampSend/doSignSendPBToCB.do",//代理行到清算行签章发送	
		PBToCB_A:"/df/f_ebank/billStampSend/doAgainSendPBToCB.do",//代理行到清算行重新发送
		CBToPB:"/df/f_ebank/billStampSend/doSendCBToPB.do",//清算行到代理行发送
		CBToPB_DES:"/df/f_ebank/billStampSend/doSendSignFromCBToPB.do",//代理银行预算外清算 签章发送  签章发送到代理银行
		CBToCZ_A:"/df/f_ebank/billStampSend/doSendCBToCZ.do",//清算行到财政重新发送
		SignOnly:"/df/f_ebank/billStampSend/doSignOnly.do",//代理银行预算外清算 本地银行作为清算行进行清算本身签章 
};
...
EBankConstant.CommonUrl = {
	    ...
	    doApplyCreate:"/df/f_ebank/agent/doCreateAgentBill.do",//直接，授权划款/退款申请生成
	    doNoticeCreate:"/df/f_ebank/common/billhandle/doCreateBill.do",//直接，授权入账通知书生成
	    doDailyCreate:"/df/f_ebank/common/billhandle/doCreateBillByBillNos.do",//直接，授权支付日报生成
	    doCancelCreateBill:"/df/f_ebank/common/billhandle/doCancelCreateBill.do",
	    doRecall:"/df/f_ebank/pay/payCommon/doCommonRecall.do",
	    doBack:"/df/f_ebank/pay/payCommon/doProcessBack.do",
	    doDelete:"/df/f_ebank/pay/payCommon/doDelete.do",
	    doNext:"/df/f_ebank/pay/payCommon/doCommonNext.do",
	    ...
	    doBatchAgentBusinessNoNext:"/df/f_ebank/pay/payCommon/doBatchAgentBusinessNoNext.do",
	    ...
	    getReportData:"/df/f_ebank/common/report/getData.do",
	    doCommonPay:"/df/f_ebank/pay/payCommon/doCommonPay.do",
	    doBatchPay:"/df/f_ebank/pay/batchPay/doBatchBillPay.do",
	    doInputAgentBusinessBatchNo:"/df/f_ebank/pay/batchPay/doConfirm.do",
};

EBankConstant.ViewId = {
		LOG_VIEW_ID : "C1A54A72-A1A1-4579-BEE7-D8C1139817C0",
};
