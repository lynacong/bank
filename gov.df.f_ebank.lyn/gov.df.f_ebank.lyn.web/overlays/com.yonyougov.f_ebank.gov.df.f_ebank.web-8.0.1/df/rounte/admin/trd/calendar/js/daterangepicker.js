...
(function (root, factory) {
    ...
    var DateRangePicker = function(element, options, cb) {
        ...
        if (typeof options.template !== 'string' && !(options.template instanceof $))
            options.template = 
            	'<iframe  src="about:blank" frameBorder="0" marginHeight="0" marginWidth="0" style="position:absolute;left:10000px;top:0;visibility: inherit;width: 255px; height: 280px; filter: chroma(color=#ffffff);"></iframe>'+
...
//            if (!this.startDate.isSame(this.oldStartDate) || !this.endDate.isSame(this.oldEndDate))
        ...
        outsideClick: function(e) {
            ...
            //注释原有的该行，因为hide()正好做了将选中的日期范围赋值给文本框
//            this.hide();
            //增加下面5行，点击面板外部时仅仅隐藏面板不赋值
