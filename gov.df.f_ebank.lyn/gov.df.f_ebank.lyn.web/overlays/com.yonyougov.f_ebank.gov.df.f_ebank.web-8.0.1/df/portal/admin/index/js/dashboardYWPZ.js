				...
				for (var i = 0; i < menuFirstLevelList.length; i++) {
					...
					for (var j in menuSecondLevelList) {
						...
						for (var k in menuThirdLevelList) {
							...
							menuListHtml += '<a class="title-three dfp-ywpz-menu-lv3" href="javascript:void(0);">' + _name + '</a>';
						}
						menuListHtml +=	'</div>'
                ...
                menuListHtml += '<div class="title-one">'+
								...
								'<div class="ywpz-container">'+
									...
									'<div class="three-content">'+
										'<a class="title-three dfp-ywpz-menu-lv3" href="javascript:void(0);" target="_blank">' + _pzName + '</a>'+
									'</div>'+
								'</div>'
...
//				menuListHtml += '<a class="btn btn-default" href="' + _pzUrl2 + '" target="_blank">' + _pzName2 + '</a>';
                ...
                $menuDiv.find(".dfp-ywpz-menu-lv3").each(function(i) {
                	$(this).on("click", function() {
                		window.parent.addTabToParent($(this).text(), urls[i]);
                	});
                });
			}
		}
