var portalGKKJFZ = {
        ...
        often: function () {
            ...
            dfpMenu.show(dfp.page.GKKJFZ, "ban", null, "oftenUlBan");
            dfpMenu.show(dfp.page.GKKJFZ, "wen", null, "oftenUlWen");
//            $("#oftenUlZhu").on("click", function () {
//                window.parent.addTabToParent("国库经办查询", dfp.fullUrl(dfp.esen.url("GKCX_TOP")));
//            });
            dfpMenu.show(dfp.page.GKKJFZ, "cha", null, "oftenUlCha");
        },
        /**
         * 中部单据、签章
         */
        agencyOperation: {
            show: function () {
            	...
            	var menu = [
                  ...
                  [menuCode[4], '支付对账', 'paymentReconciliation'],
                  [menuCode[5], '实拨对账', 'actualAppropriationReconciliation']
                  ];
...
$(function () {
    ...
    portalGKKJFZ.agencyOperation.show();
    $("#middleRefresh").on("click", function() {
        portalGKKJFZ.agencyOperation.show();
    });
    
    portalGKKJFZ.checkPayment.echart();
    portalGKKJFZ.checkPayment.select();
    portalGKKJFZ.checkPayment.table();
