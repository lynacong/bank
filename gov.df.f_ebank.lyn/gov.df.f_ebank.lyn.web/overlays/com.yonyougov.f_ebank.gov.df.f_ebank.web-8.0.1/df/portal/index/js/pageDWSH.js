	...
	bf : function(){
		...
		$(".hid").mouseover(function(){
            ...
            if (imgPath.indexOf("ban") > 0) {
                imgPath = "img/menu/often-ban-w.png";
            }
            if (imgPath.indexOf("deng") > 0) {
                imgPath = "img/menu/often-deng-w.png";
            }
            if (imgPath.indexOf("cha") > 0) {
                imgPath = "img/menu/often-cha-w.png";
            }
            if (imgPath.indexOf("wen") > 0) {
                imgPath = "img/menu/often-wen-w.png";
            }
			...
			var imgPath = $(this).find("a").find("img").prop("src");
            if (imgPath.indexOf("ban") > 0) {
                imgPath = "img/menu/often-ban.png";
            }
            if (imgPath.indexOf("deng") > 0) {
                imgPath = "img/menu/often-deng.png";
            }
            if (imgPath.indexOf("cha") > 0) {
                imgPath = "img/menu/often-cha.png";
            }
            if (imgPath.indexOf("wen") > 0) {
                imgPath = "img/menu/often-wen.png";
            }
			$(this).find("a").find("img").prop("src", imgPath);
...
$(function(){
	...
	dfpMenu.show("SH", "cha", "woyaocha");
	dfpMenu.show("SH", "wen", "woyaowen");
	ptd_dwsh_often.bf();
...
//	dfpArticle.bf();
	...
	$("#budgetGridMax").click(function() {
		dfp_util.maxDiv("leftDownBudgetGrid");
