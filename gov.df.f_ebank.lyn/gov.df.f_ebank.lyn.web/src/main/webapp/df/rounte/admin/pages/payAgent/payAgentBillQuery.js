define(['text!pages/payAgent/payAgentBillQuery.html',
	...
	viewModel.initData = function() {
		var pageData = commonUtil.initPageData("buttonArea","searchArea","statusArea","mainGridArea","",
				mainOptions,"",false);
	...
	//通用更新
		updateField=function(){
            ...
            optionsParam["billIdsAndFinanceCode"]=JSON.stringify(billIdsAndFinanceCode);
            optionsParam["ajax"]="nocache";
            ip.processInfo("正在处理中，请稍候......", true);
            $.ajax({
                url : EBankConstant.Ctx + "payAgentBill/updateField.do?tokenid="+ viewModel.tokenid,
                type : "POST",
                data : optionsParam,
